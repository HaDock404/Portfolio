...
function App() {
  ...
  return (
    <CardFunction>
      ...
      <br />
      <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<CardPink id="el4">const</CardPink> <CardYellow id="el5">bio</CardYellow> = <CardPurple id="el6">“Hello, I’m front-end developer and this is my website”</CardPurple>
      <br />
      <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<CardPink id="el7">let</CardPink> <CardOrange id="el8">english;</CardOrange>
      <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<CardPink id="el9">let</CardPink> <CardOrange id="el10">français;</CardOrange>
      <br />
      <br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<CardPink id="el11">return</CardPink> <CardYellow id="el12">bio</CardYellow>(<CardOrange id="el13">français</CardOrange>)
      <br />
      <br />
      &#125;
    </CardFunction>
